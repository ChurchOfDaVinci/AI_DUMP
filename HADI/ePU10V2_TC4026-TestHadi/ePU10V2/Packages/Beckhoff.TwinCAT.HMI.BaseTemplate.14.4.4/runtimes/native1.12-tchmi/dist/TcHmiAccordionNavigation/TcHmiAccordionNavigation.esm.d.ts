import { Controls, type Locale, ObjectResolver, TcHmiControl, TcHmiRegion, type AccessControl, type Color, type DestroyFunction, type FontSizeUnit, type IFunction, type SolidColor } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
...
declare class TcHmiAccordionNavigation extends TcHmiControl.Control {
    #private;
    /**
    ...
    protected __elementBaseAccordion: Helpers.Accordion;
    /** Back button element */
     ...
     */
    protected __createNavigationLevel(items: NavigationItem[], accordionElement: Helpers.Accordion, even?: boolean): void;
    /**
     ...
     */
    protected __onItemSelected(item: Helpers.AccordionItem): void;
    /**
     * Updates the visual representation of the active item and the previously active items.
     */
    protected __updateDisplayOfActiveItem(activeItem: Helpers.AccordionItem): void;
    /**
     ...
     */
    protected __onItemDownChanged(item: Helpers.AccordionItem): void;
    /**
     ...
     */
    protected __getAccordionItemById(id: string): Helpers.AccordionItem | null;
    /**
     ...
     */
    protected __getParentItem(item: NavigationItem): Helpers.AccordionItem | null;
    /**
     ...
     */
    protected __getSubRights(items: NavigationItem[], accessList: AccessControl[]): AccessControl[];
    /**
     ...
     */
    protected __onResolverForNavigationStructureWatchCallback(data: ObjectResolver.IWatchResultObject<NavigationItem[]>): void;
    /**
     ...
     */
    protected __onResolverForTextColorActiveWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForTextColorPressedWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
    /**
     ...
     */
    protected __onResolverForButtonBackgroundColorWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     ...
     */
    protected __onResolverForButtonBackgroundColorActiveWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
    /**
     * Sets the background value and calls the associated process function.
     * @param valueNew
     * @preserve (Part of the public API)
     ...
     */
    protected __onResolverForButtonBackgroundColorPressedWatchCallback(data: ObjectResolver.IWatchResultObject<Color>): void;
}
...
export { TcHmiAccordionNavigation as Control };
