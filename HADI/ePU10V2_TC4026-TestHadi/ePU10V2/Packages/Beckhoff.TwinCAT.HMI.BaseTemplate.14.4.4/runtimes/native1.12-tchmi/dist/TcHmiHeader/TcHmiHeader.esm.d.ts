import { Controls, EventProvider, ObjectResolver, TcHmiControl, TcHmiRegion, type AccessControl, type DestroyFunction, type DimensionUnit, type Filter, type SortingInfo } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import type { TcHmiAdsState, TcHmiButton, TcHmiEventLine, TcHmiLocalizationSelect, TcHmiStateImage } from 'Beckhoff.TwinCAT.HMI.Controls/index.esm.js';
declare class TcHmiHeader extends TcHmiControl.Control {
    #private;
    /**
    ...
    protected __expandButton: TcHmiButton.Control | undefined;
     ...
     */
    protected __onElementClick(item: IHeaderItems): (_event: EventProvider.Event) => void;
    /**
     ...
     */
    protected __getSubRights(elements: IHeaderItems[], accessList: AccessControl[]): AccessControl[];
    /**
    ...
    /**
     * Update the properties of an existing EventLine control.
     */
    protected __updateEventLine(item: IHeaderItems): void;
    /**
    ...
    protected __updateUserManagement(item: IHeaderItems): void;
    /**
    ...
    /**
     * Update the properties of an existing Image control.
     */
    protected __updateImage(item: IHeaderItems): void;
    ...
    /**
     * Update the properties of an existing Text control.
     */
    protected __updateText(item: IHeaderItems): void;
    /**
    ...
    /**
     * Update the properties of an existing StateImage control.
     */
    protected __updateStateImage(item: IHeaderItems): void;
    /**
    ...
    /**
     * Update the properties of an existing AdsState control.
     */
    protected __updateAdsState(item: IHeaderItems): void;
    /**
     * create a Time element and append it to the Control
     * @param item An item with the itemType 'Time' a control will be created and attached to the DOM.
     */
    protected __createTime(item: IHeaderItems): void; /**
     * Update the properties of an existing Time control.
     */
    protected __updateTime(item: IHeaderItems): void;
    /**
    ...
    /**
     * Update the properties of an existing LocalizationSelect control.
     */
    protected __updateLocalizationSelect(item: IHeaderItems): void;
    /**
     ...
     */
    protected __onResolverForHeaderItemsWatchCallback(data: ObjectResolver.IWatchResultObject<IHeaderItems[]>): void;
    /**
    ...
    /**
     * Check if an header items dimension related property has changed
     */
    protected __getChangedProperties(currentItem: IHeaderItems, newItem: IHeaderItems): {
...
export interface IHeaderItems {
    ...
    control: TcHmiControl.Control | undefined;
    ...
    messageFormat?: TcHmiEventLine.MessageFormat;
    ...
    targetRegion?: string | TcHmiRegion.Control;
    ...
    stateList?: TcHmiStateImage.IStateStructure[];
    /** State symbol value for the status icon */
    stateVar?: any;
    /** Changes the label for each localization identifier */
    localizationMapping?: TcHmiLocalizationSelect.ListItem[];
    ...
    serverDomain?: string;
    /** ads state images */
    stateImages?: TcHmiAdsState.IStateImages;
    /** width of the icon */
    iconWidth?: number;
