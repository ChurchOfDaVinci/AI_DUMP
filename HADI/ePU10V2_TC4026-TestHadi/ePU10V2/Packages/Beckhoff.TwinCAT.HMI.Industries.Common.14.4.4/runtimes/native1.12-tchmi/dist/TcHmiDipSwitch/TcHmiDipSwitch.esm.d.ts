import { Controls, EventProvider, type SolidColor, type ObjectResolver } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
import { TcHmiButton } from 'Beckhoff.TwinCAT.HMI.Controls/index.esm.js';
import type * as Helpers from '../Helpers/_Types.js';
declare class TcHmiDipSwitch extends TcHmiButton.Control {
    #private;
    ...
    /** Inactive color of the dip switch */
    protected __inactiveColor: SolidColor | null | undefined;
    /** Active color of the dip switch */
...
export { TcHmiDipSwitch as Control };
declare const _TcHmiDipSwitch: typeof TcHmiDipSwitch;
type tTcHmiDipSwitch = TcHmiDipSwitch;
declare global {
    namespace TcHmi.Controls.Beckhoff.Industries.Common {
        const TcHmiDipSwitch: typeof _TcHmiDipSwitch;
        type TcHmiDipSwitch = tTcHmiDipSwitch;
    }
}
//# sourceMappingURL=TcHmiDipSwitch.esm.d.ts.map