import { TcHmiControl, Symbol, type DestroyFunction, type SolidColor, ObjectResolver, Controls } from 'Beckhoff.TwinCAT.HMI.Framework/index.esm.js';
declare class TcHmiIndicatorLight extends TcHmiControl.Control {
    ...
    protected __stateSymbol: Symbol<boolean> | undefined | null;
     ...
     */
    setStateSymbol(valueNew: Symbol | null): void;
    /**
    ...
    protected __processStateSymbolResult(data: Symbol.IReadResultObject<boolean>): void;
    /**
