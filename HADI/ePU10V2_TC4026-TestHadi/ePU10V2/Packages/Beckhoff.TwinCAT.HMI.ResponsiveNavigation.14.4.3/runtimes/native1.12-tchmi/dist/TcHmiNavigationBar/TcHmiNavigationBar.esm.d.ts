...
declare class TcHmiNavigationBar extends TcHmiControl.Control {
    ...
    protected __onResolverForMenuSourceDataCallback(data: ObjectResolver.IWatchResultObject<MenuItem[]>): void;
     ...
     */
    protected __onResolverForHighLightColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
     ...
     * The watch callback for the textColor object resolver.
     */
    protected __onResolverForFontColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
     ...
     * The watch callback for the textColor object resolver.
     */
    protected __onResolverForTriangleColorWatchCallback(data: ObjectResolver.IWatchResultObject<SolidColor>): void;
